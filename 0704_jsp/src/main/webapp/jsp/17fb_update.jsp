...
<html>
	...
	<body>
		...
		<%
			BoardDTO dto 
				= (BoardDTO)request.getAttribute("free_board_detail");
			if(dto ==null){
				...
				<tr>
					...
					<td>
						<input type="text" id="title" name="title" 
							maxlength="50" class="form-control" value="<%=dto.getBtitle()%>">
					</td>
				</tr>
				<tr>
					<td>작성자</td>
					<td>
						<input type="text" id="writer" name="writer" 
							maxlength="50" class="form-control" value="<%=dto.getBwriter()%>">
					</td>
				</tr>
				<tr>
					<td>내용</td>
					<td>
						<textarea rows="10" id="cnts" name="cnts" class="form-control"><%=dto.getBcnts()%></textarea>
					</td>
				</tr>
			</tbody>
			<tfoot>

...
<html>
	...
	<body>
		...
		<form action="./04parameter_take.jsp" method="get">
			...
			<hr>
			PASSWORD : <input type="password" id="mpwd" name="mpwd">
			<hr> 
			<button type="submit">파리미터 보내기</button>
		</form>
		
		<%-- 지금 만든 html코드는 
			1. 클라이언트에게 전송되어  
			2. 유저가 id/pwd 입력후 전송버튼을 누르면 
			3. form의 action으로 전달된다. --%>
		<%-- **서버는 결국 html을 클라이언트(유저)에게 전달한다. 서버에서 실행되는것이 아니다. --%>
	</body>
</html>